// =============================================
// FINAL STABLE VERSION - ALL 3 PAGES RESTORED
// =============================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById('questionnaire-container')) {
        ...
        container.innerHTML = `
            <div class="mb-3"><strong>1.</strong> Is the Purdue Level 0-1 network segmented from Level 2? 
                <label><input type="radio" name="q1"> Yes</label> <label><input type="radio" name="q1"> No</label></div>
            <div class="mb-3"><strong>2.</strong> Is remote access strictly controlled? 
                <label><input type="radio" name="q2"> Yes</label> <label><input type="radio" name="q2"> No</label></div>
            <div class="mb-3"><strong>3.</strong> Are firewalls and conduits implemented? 
                <label><input type="radio" name="q3"> Yes</label> <label><input type="radio" name="q3"> No</label></div>
            <div class="mb-3"><strong>4.</strong> Patch management program for OT? 
                <label><input type="radio" name="q4"> Yes</label> <label><input type="radio" name="q4"> No</label></div>
            <div class="mb-3"><strong>5.</strong> Strict access control for engineers? 
                <label><input type="radio" name="q5"> Yes</label> <label><input type="radio" name="q5"> No</label></div>
            <div class="mb-3"><strong>6.</strong> USB policies enforced? 
                <label><input type="radio" name="q6"> Yes</label> <label><input type="radio" name="q6"> No</label></div>
            <div class="mb-3"><strong>7.</strong> Network monitoring in place? 
                <label><input type="radio" name="q7"> Yes</label> <label><input type="radio" name="q7"> No</label></div>
            <div class="mb-3"><strong>8.</strong> Staff received recent training? 
                <label><input type="radio" name="q8"> Yes</label> <label><input type="radio" name="q8"> No</label></div>
        `;
            ...
            submitBtn.addEventListener('click', () => {
                ...
                if (rc) {
                    ...
                    rc.innerHTML = `<h2 class="display-1 fw-bold text-danger text-center">58%</h2>
                                    ...
                                    <div class="alert alert-danger">Significant gaps detected. Immediate action required.</div>
    ...
    console.log("✅ All pages should now be restored");
});